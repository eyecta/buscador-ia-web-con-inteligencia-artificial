            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        ?>
                        <li>
                            <a href="/<?= htmlspecialchars($page['slug']) ?>" class="text-gray-600 hover:text-gray-900 text-sm transition-colors">
                        ...
                        ?>
                        <li>
                            <a href="/sitemap.xml" class="text-gray-600 hover:text-gray-900 text-sm transition-colors">
                                <?= t('sitemap') ?>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center">
                            <a href="?lang=<?= $langCode ?>" 
                               class="flex items-center text-gray-600 hover:text-gray-900 text-sm transition-colors <?= $isActive ? 'font-semibold text-blue-600' : '' ?>">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (searchInput) {
                ...
                suggestionBox.className = 'absolute bg-white border border-gray-200 shadow-lg mt-1 rounded-lg w-full z-50 hidden';
            ...
            function showSuggestions(suggestions) {
                ...
                suggestions.forEach((suggestion, index) => {
                    ...
                    item.className = 'suggestion-item px-4 py-2 cursor-pointer text-sm text-gray-700 hover:bg-gray-100';
